...
using System.IO;
using SplashKitSDK;
using MyGame;  // Add this to access the ExtensionsMethods
...
namespace ShapeDrawing
{
    ...
    public abstract class Shape
    {
        ...
        // POLYMORPHISM: Virtual method that can be overridden by child classes
        // Base implementation saves common Shape properties
        ...
        // POLYMORPHISM: Virtual method for loading shape data from file
        // Base implementation loads common Shape properties
