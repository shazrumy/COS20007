...
namespace SwinAdventureTest
{
    ...
    public class BagTest
    {
        ...
        //     Assert.That(b1.Locate("en310"), Is.Null);  // Use lowercase
        //     Assert.That(b1.Locate("secret"), Is.Null);

        //     // However, b2 should still be able to locate its own privileged item
        //     Assert.That(b2.Locate("en310"), Is.EqualTo(privilegedItem));  // Use lowercase
        // }
        ...
        public void BagPrivilegedItem()
        {
            ...
            // However, b2 should still be able to locate its own privileged item
            Assert.That(b2.Locate("secret"), Is.EqualTo(privilegedItem));
        }
    }
}
